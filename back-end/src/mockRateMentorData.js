const mentorRateData =[ 
    {id: 1, first_name:'Olivia', last_name:'Smith', 
        currentRate:5, rates : [5,5,5], 
        school:'CAS',
        language: 'English',
        year: 'First Year',
        major: 'Math',
        lastChatTime: 2},
    {id: 2, first_name:'Elijah', last_name:'Johnson', 
        currentRate:3.6, rates : [5,3,3], 
        school:'Tandon',
        language: 'French',
        year: 'Sophomore',
        major: 'Computer Science',
        lastChatTime: 3},
    {id: 3, first_name:'Ava', last_name:'Williams', 
        currentRate:3.3, rates : [5,3,2],
        school:'Silver',
        language: 'Chinese',
        year: 'Junior',
        major: 'Finance',
    ...
    {id: 4, first_name:'Liam', last_name:'Brown', 
        currentRate: 3, rates : [4,3,2], 
        school:'Stern',
        language: 'Spanish',
        year: 'Senior',
        major: 'Finance',
        lastChatTime: 20},
    {id: 5, first_name:'Joe', last_name:'Jones', 
        currentRate:2.6, rates : [3,3,2], 
        school:'GSAS',
        language: 'English',
        year: 'Senior',
        major: 'Math',
